    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $().ready(function(){
                    ...
                    if($('#datepickerHasta').val()!=$('#datepickerDesde').val()){
                        if(comparaFecha($('#datepickerHasta').val(),$('#datepickerDesde').val())){
                            if($("#frmConsultarViajes").validate().element('#datepickerDesde') & $("#frmConsultarViajes").validate().element('#datepickerHasta')){
                                $.post("../../request/viaje/ajaxGetViajesConductor.php", $('#frmConsultarViajes').serialize(), function(r){
                                    if(r!="false"){
                                        $('#tablaViajes').html(r);
                                        $.post("../../request/viaje/ajaxGetTotalViajesConductor.php", $('#frmConsultarViajes').serialize(), function(r){
                                            $('#totalPago').html(r);
                                        });
                ...
                $("a[name='deshacerPago']").live("click",function(){
                    $.post("../../request/viaje/ajaxDeshacerPago.php",{id:this.id}, function(){
                        $('#btnBuscar').click();
                    });
                    $.post("../../request/viaje/ajaxGetTotalViajesConductor.php", $('#frmConsultarViajes').serialize(), function(r){
                        $('#totalPago').html(r);
                ...
                $('#btnPagarViajes').live("click",function(){
                    $.post("../../request/viaje/ajaxPagarConductor.php", $('#frmConsultarViajes').serialize(), function(){
                        $('#btnBuscar').click();
                    })
                });
        ...
        <div id="main">
            ...
            <div id="contenido">
                <div id="maincontenido">
                    ...
                    <span class="titulo">VIAJES CONDUCTORES</span><br><br>
                    <form id="frmConsultarViajes"><br>
                        ...
                        <select id="selectConductor" name="selectConductor">
<?php $conductor->getCombolModel("conductores", "nombre") ?>
                        </select>
                    ...
                    <input id="btnPagarViajes" type="button" name="btnPagarViajes" value="PAGAR VIAJES">
                    <br><br><br><br>
