...
if($departamentosList!=false){
    ...
    while($dpto=pg_fetch_array($departamentosList)){
        ...
        <td>$modalidad</td>
        <td>$ruta</td>"."
        <td><a id='".$id."' name='eliminar'>Sacar del Lote</a>&nbsp;&nbsp;<a id='".$id."' name='eliminar-viaje'>Eliminar</a>&nbsp;&nbsp;<a id='".$id."' name='clonarViaje3'>Clonar3</a>&nbsp;&nbsp;<a id='".$id."' name='editarViaje3'>Editar Viaje3</a>&nbsp;&nbsp;</td>
      </tr>";
