...
if($list!=false){
    ...
    while($row=pg_fetch_array($list)){
        ...
        $etiquetaEstado
        $trPago
        <td><a id='".$id."' name='visualizarLote' href='viewVisualizar.php?id=$id"."&empresa=$empresa_id'>Visualizar lote</a>&nbsp;&nbsp;&nbsp;<a id='".$id."' name='eliminar'>Eliminar</a>&nbsp;&nbsp;<a id='".$id."' name='editar'>Editar</a></td>
      </tr>";
    }
}
cerrarConexion();
